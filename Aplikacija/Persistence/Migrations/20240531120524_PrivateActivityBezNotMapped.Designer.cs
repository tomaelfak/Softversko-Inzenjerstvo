...
namespace Persistence.Migrations
{
    ...
    [Migration("20240531120524_PrivateActivityBezNotMapped")]
    partial class PrivateActivityBezNotMapped
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.PrivateActivityParticipant", b =>
                {
                    b.Property<Guid>("AppUserId")
                        .HasColumnType("TEXT");

                    b.Property<Guid>("PrivateActivityId")
                        .HasColumnType("TEXT");

                    b.Property<bool>("IsHost")
                        .HasColumnType("INTEGER");

                    b.HasKey("AppUserId", "PrivateActivityId");

                    b.HasIndex("PrivateActivityId");

                    b.ToTable("PrivateActivityParticipant");
                });
            ...
            modelBuilder.Entity("Domain.PrivateActivityParticipant", b =>
                {
                    ...
                    b.HasOne("Domain.PrivateActivity", "PrivateActivity")
                        .WithMany("PrivateParticipants")
                        .HasForeignKey("PrivateActivityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AppUser");

                    b.Navigation("PrivateActivity");
                });
